...
public final class QrCode extends AsyncTask<String, Void, Bitmap> {
    ...
    /**
     * Builds the structure of the QR Code. No loading indicator will be shown by default.<br>
     * Call {@link #setLoadingMessage(Context, String)} or {@link #setLoadingMessage(android.content.Context, int)}
    ...
    /**
     * Sets a loading message for the dialog
     */
    public void setLoadingMessage (Context context, int messageResourceId) {
        final String message = context.getString(messageResourceId);
        setLoadingMessage(context, message);
    }

    /**
     * Sets a loading message for the dialog
     */
    public void setLoadingMessage (Context context, String message) {
    ...
    private void dismissDialog () {
        if (mShowLoading && (mProgressDialog != null) && (mProgressDialog.isShowing())) {
